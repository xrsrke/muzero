# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/games/01_four_chess.ipynb.

# %% auto 0
__all__ = ['get_init_board', 'place_piece', 'get_valid_moves', 'is_board_full', 'is_win']

# %% ../../nbs/games/01_four_chess.ipynb 3
import numpy as np
from .view_board import draw_board, render

# %% ../../nbs/games/01_four_chess.ipynb 4
